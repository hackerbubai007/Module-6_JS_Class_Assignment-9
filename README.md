...
Hosted Link: https://hackerbubai007.github.io/Module-6_JS_Class_Assignment-9/index.html
...
<div id="targetDiv">This is a sample div created By Dipankar Mandal.</div>
```
...
Here I select elements from my html file by " document.getElementById " .Then,I use a function which is change the values. I target the div to specify the particular style and change the value.
